...
import {
  ...
  TrendingUp, Settings, Flame, X, Code2, BookOpen, Award, Shield, AppWindow, Download
} from 'lucide-react';
  ...
  return (
    <>
      <aside className={clsx(
        'flex flex-col bg-[#020403] border-r border-[#142a20] h-full selection:bg-emerald-500/30 select-none z-20',
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#142a20] bg-[#050806]">
          <NavLink to="/dashboard" onClick={mobile ? onClose : undefined} className="flex items-center">
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          ...
          <div className="pt-2 px-1">
            <button
              ...
              className="w-full flex items-center justify-between px-3.5 py-3 rounded-2xl bg-[#04130a] border border-emerald-500/40 text-emerald-300 hover:bg-[#092213] hover:border-emerald-400 transition-all group shadow-[0_0_15px_rgba(16,185,129,0.15)] text-xs font-mono font-semibold"
            >
