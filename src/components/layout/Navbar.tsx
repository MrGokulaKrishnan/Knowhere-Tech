    ...
    <>
      <header className="h-[76px] flex items-center justify-between px-6 lg:px-10 border-b border-[#142a20] bg-[#000000]/90 backdrop-blur-md shrink-0 z-30 select-none">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-[#050806] border border-[#142a20] text-zinc-400 hover:border-emerald-500/50 hover:text-white hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] transition-all text-xs mx-4 flex-1 max-w-md"
          aria-label="Search lessons and topics (Ctrl+K)"
        >
          <Search size={16} className="text-emerald-400 shrink-0" />
          <span className="hidden sm:inline font-mono">Search concepts, syntax, interview questions...</span>
          <span className="sm:hidden font-mono">Search...</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-[#06150c] border border-emerald-500/40 text-emerald-300 hover:bg-[#0c2616] hover:border-emerald-400 text-xs font-semibold font-mono transition-all hover:scale-[1.02] shadow-[0_0_15px_rgba(16,185,129,0.15)]"
          ...
          <div className="hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-[#050806] border border-[#142a20] text-xs">
            <Flame size={15} className="text-amber-400" />
            <span className="text-amber-300 font-mono font-bold">{progress?.streak || 1}d Streak</span>
          </div>

          <div className="flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-emerald-950/50 border border-emerald-500/40 text-xs shadow-[0_0_15px_rgba(16,185,129,0.15)]">
            <Zap size={15} className="text-emerald-400" />
            <span className="text-emerald-300 font-mono font-bold">{(progress?.xp || 0).toLocaleString()} XP</span>
          </div>

          <div className="hidden lg:flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-[#050806] border border-[#142a20] text-xs text-emerald-300">
